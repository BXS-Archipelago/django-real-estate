...
class Profile(TimeStampedUUIDModel):
    ...
    phone_number = PhoneNumberField(verbose_name=("Phone Number"), max_length=30, default="+1-555-21212")
    ...
    country = CountryField(verbose_name=_("Countyr"), default="USA", blank=False, null=False)
    city = models.CharField(verbose_name=_("City"), max_length=180, default="Washington DC", blank=False, null=False)
    is_buyer = models.BooleanField(verbose_name=_("Buyer"), default=False,
                                   help_text=("Are you purchasing a Property?"))
